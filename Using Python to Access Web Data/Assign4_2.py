...
#Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Dillan.html
...
while i < count:
    ...
    print("Retrieve link ",tags[pos-1].get('href',None))
    i = i+1
print("The answer to the assignment for this execution is",tags[pos-1].contents)
